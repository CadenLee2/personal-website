  ...
  return (
    <PageFrame pageName='blog'>
      ...
      <div className="section">
        ...
        <p>
          This perspective can be called <i>ownership</i>--it's your project, and the success of the project is your own success.
        </p>
      </div>
      <div className="section">
        ...
        <p>
          One example is sharing projects with friends. In high school, I worked on a browser extension game called <a href="https://github.com/Cadecraft/tetrome-source">Tetrome</a>. After giving it to my friends to try, I enjoyed watching them try out the various modes, configure the controls, and so on; they also told me about bugs and intentionally tried to cause glitches in the block physics. This kind of game reflects personally on the developer--I was the one who had to fix the bugs, and if everyone wanted a new feature, I was the one who got to make that happen. By sharing the game, I felt prouder of my progress.
        </p>
        <p>
          You might also share code with other developers, such as by making open-source projects accessible online. Since the code you write is a reflection of yourself, you won't want to be embarrassed if someone else sees it. When I look back at my older projects like Tetrome, I find there's a lot that could be refactored; I could spend a whole day improving the code quality and it would be satisfying. Nowadays, when I work on new projects, I tend to make decisions assuming someone else will see my code. This encourages me to keep things readable and correct (it always pays off, even if that "someone else" reading the code is just my future self). Because I'm sharing it, I feel responsible for the code to be written well.
        </p>
        <p>
          Considering that some of these aspects are social rather than purely individual, this raises a question: is ownership always possible in team projects as well?
        </p>
      </div>
      <div className="section">
        ...
        <ul>
          ...
          <li>
            Growing a userbase and making a profit. During my fellowship at UCI's Product Association, my product team worked on <a href="http://knickknackapp.com/">KnickKnack Marketplace</a> and researched market potential, competitors, and monetization methods surrounding figurine trading.
          </li>
        </ul>
        <p>
          Because these motivations are shared, they may not line up with every member of the team. For instance, as a software engineer in the Product fellowship (mentioned above), I had initially joined to apply my technical skills and deploy an app, not to compare business ideas and create financial projections. As the purpose of the fellowship was to create a successful startup in the end--which fundamentally requires those business and financial aspects--this kind of mismatch means that ownership isn't always a guarantee from the start in teams.
        </p>
        <p>
          When the project motivation no longer matches the individual motivation, the individual motivation will shift to become however progress is evaluated:
        </p>
        <ul>
      ...
      <div className="section">
        ...
        <p>
          The following considerations won't apply to every team project, but from my own experience, they've helped me and those around me. Note that you'd implicitly experience most of these in any personal project.
        </p>
        <h3>As a member</h3>
        <ul>
          <li>
          ...
          <li>
            Get to know your teammates. Because teams are made of people, if you're able to get to know the people better, you'll have a more personal connection to the project as a whole. It's one thing to work with a peer, but another to work with a friend.
          </li>
          <li>
            Bring up your own concerns and ideas. When possible, being able to take something from your mind to a real feature in production gives you something to be proud of.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            Let everyone bring something to the table, encouraging members to raise concerns and implement their own ideas. When people think critically, even disagreeing with requirements at times, they're able to solve problems creatively and improve the project in unique ways.
          </li>
        </ul>
        <p>
          For those last few bullet points, I'm still experimenting and figuring out how else I can improve the PeterPortal team dynamic; this list will grow over time.
        </p>
      </div>
      <div className="section">
