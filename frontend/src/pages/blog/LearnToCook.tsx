  ...
  return (
    <PageFrame pageName='blog'>
      ...
      <div className="section">
        ...
        <p>
          Secondly, it'll most likely be <a href="https://www.health.harvard.edu/blog/home-cooking-good-for-your-health-2018081514449">healthier than eating out</a>. This of course depends on what you make, but it's quite clear that a homemade burger is healthier than McDonald's.
        </p>
        <p>
      ...
      <div className="section">
        ...
        <ol>
          <li>Follow existing principles, forms, and best practices rigidly, so that you can get an intuitive sense of judgment based on the advice of more experienced people. You should rely on one teacher or a consistent set of resources. Without this basis, you're wandering aimlessly (this is the mistake I made at first with cooking).</li>
      ...
      <div className="section">
        ...
        <p>
          Beyond merely <i>involving</i> skill, I further consider cooking to be a <i>skill-based</i> hobby rather than an <i>accumulation-based</i> one. To compare the two concepts, compare two well-known games:
        </p>
        <ol>
          <li>
            Chess: the outcome of a match is determined entirely by the player's skill; if a professional player logs into any chess website, no matter how new their account may be, they'll be just as good. As such, progress is defined by improving a skill. Another example is my favorite browser game <a href="https://tetr.io/">TETR.IO</a>.
            <ul>
              <li><span className="codesmall">progress = f(skill)</span></li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              <li><span className="codesmall">progress = f(skill, your collection)</span></li>
            </ul>
          </li>
        </ol>
        <p>
          When it comes to hobbies, we can similarly contrast cooking against something like residential gardening, which is accumulation-based in that it depends on the long-term status of your garden. While your skill at gardening <i>is</i> indeed critical, your sense of progress in gardening is also based on the health of your plants, the landscaping you've done, and the pots you've collected over the span of years<FootnoteRef num={5} />.
        </p>
        <p>
        ...
        <p>
          Skill-based and accumulation-based activities are both fulfilling. However, what I like about cooking is that if we assume that skill only increases with time, then by definition you cannot lose long-term progress and this makes it a robust hobby.
        </p>
        <p>
          Additionally, cooking isn't easily quantifiable or gamifiable--no one cares how many hours you've spent in the kitchen if your food is still bad. Your skill can only be evaluated by the subjective question "how is the dish?" In a world where people are constantly trying to maximize their step count or Duolingo streak, it can be refreshing to aim at simply <i>getting better at cooking</i>, and to do so <a href="https://cadenlee.dev/blog/building_for_yourself">for yourself</a>.
        </p>
      </div>
      <div className="section">
      ...
      <div className="section">
        ...
        <FootnoteContent num={1}>
          ...
          <ul>
            ...
            <li>So, adding the amounts up respectively: <span className="codesmall">$2/lb * 0.3 + $4/lb * 0.4 + $2/12 * 2 + $1/lb * 0.4 = $2.93</span>.</li>
          </ul>
        </FootnoteContent>
