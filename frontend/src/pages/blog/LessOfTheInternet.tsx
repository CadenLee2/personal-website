  ...
  return (
    <PageFrame pageName='blog'>
      ...
      <div className="section">
        ...
        <p>
          The Internet today is nothing like a quiet bookstore: instead, flashing colors, ads, reels, promotions, products, comments, and suggestions are thrown in our faces. In fact, many companies [require us to pay to see *less*](https://www.youtube.com/premium)! Like most of my peers, I don't consider this kind of content consumption to be intellectually valuable. Doomscrolling is near-universally considered 'brainrot', a feedback loop that tires us out and wastes our time.
        </p>
        <p>
          Fundamentally, this short-form world is only possible because [the cost of copying data has reached zero](https://cadenlee.dev/blog/defense_of_digital), allowing us to obtain any information at any time. But if information is more accessible than ever before, then why does life in the 21st century feel like ["our brains are shrinking"](https://knowyourmeme.com/memes/our-brains-are-shrinking)?
        </p>
        <p>
