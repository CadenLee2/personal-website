  ...
  return (
    <PageFrame pageName='blog'>
      ...
      <div class="section">
        ...
        <p>
          Taking inspiration from the analysis of algorithms in computer science, let us define <span class="codesmall">n</span> to be the amount (lines, words, etc.) we write. We can describe the <i><a href="https://en.wikipedia.org/wiki/Big_O_notation">complexity</a></i> of a process by identifying how the amount of resources required grows as <span class="codesmall">n</span> grows.
        </p>
        <p>
        ...
        <table>
          ...
          <tbody>
            <tr>
              <td>Time to write</td>
              <td><span class="codesmall">O(n)</span></td>
              <td><span class="codesmall">O(n)</span></td>
            </tr>
            <tr>
              <td>Time to copy <span class="codesmall">k</span> times</td>
              <td><span class="codesmall">O(n·k)</span></td>
              <td><span class="codesmall">O(1)</span></td>
            </tr>
            <tr>
              <td>Time to send to <span class="codesmall">k</span> people</td>
              <td><span class="codesmall">O(k)</span></td>
              <td><span class="codesmall">O(1)</span></td>
            </tr>
            <tr>
              <td>Time to erase/mass-edit a page <span class="codesmall">k</span> lines long</td>
              <td><span class="codesmall">O(k)</span></td>
              <td><span class="codesmall">O(1)</span></td>
            </tr>
            <tr>
              ...
              <td><span class="codesmall">O(lg(n))</span></td>
              <td><span class="codesmall">O(1)</span></td>
            </tr>
            <tr>
      ...
      <div class="section">
        ...
        <p>
          ...
          <span class="codesmall">.txt</span>,{' '}
          <span class="codesmall">.md</span>, or{' '}
          <span class="codesmall">.cpp</span> file,{' '}
      ...
      <div class="section">
        ...
        <ul>
          ...
          <li>Organizing your files well (to achieve that essentially-<span class="codesmall">O(1)</span> lookup time)</li>
